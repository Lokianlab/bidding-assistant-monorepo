...
04-數據架構.md|plan|04-數據架構.md|待推|Notion/PCC/localStorage/檔案系統資料流全貌 + 欄位對照 + 設定型別 + Phase 2 方向
07-部署與成本.md|plan|07-部署與成本.md|待推|Phase 1/2 部署架構 + 月度成本($0/$21) + 預算警戒線
09-Prompt管理策略.md|plan|09-Prompt管理策略.md|待推|Prompt 清單盤點 + 版控策略 + 組裝機制 + 演進流程
skill-system-v2.md|rule|CLAUDE.md, .claude/commands/*, .claude/rules/*|已推|Skill 重構 + 計分板 + 獎懲回饋機制 — 已落地（CLAUDE.md+rules+Skill 檔全部完成）
claude-md-simplify-v2.md|rule|CLAUDE.md|已推|CLAUDE.md 第二輪精簡 378→208 行 — 已落地

SNAPSHOT|20260223-0210|AINL
[x] infra-sync|首次同步完成|@op:20260221-AINL#1924
[ ] feat-test-coverage|補測試覆蓋+跨機器審查|64 檔 1310 tests。本次：+useDashboardMetrics 65 + useFitScore 修正（跨機器重構對應）。跨機器審查：A44T docgen/ToolFileDialog 通過、ITEJ KB/CustomOptions/Logger/PCC 邊界/pricing/assembly 通過

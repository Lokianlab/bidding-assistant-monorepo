SNAPSHOT|20260223-0000|AINL
[x] infra-sync|首次同步完成|@op:20260221-AINL#1924
[ ] feat-test-coverage|補測試覆蓋+跨機器審查|57 檔 1195 tests。跨機器審查：A44T docgen/ToolFileDialog 通過、ITEJ KB/CustomOptions/Logger/PCC 邊界/pricing/assembly 通過
...
[v] feat-scout-committee|P偵察加入評委情報|已知資訊段含評委人數/外聘名單，查詢段含評委背景問題，+6 tests。驗收：開啟案件詳情 → 按 Scout 按鈕 → 檢視 prompt 含評委段落

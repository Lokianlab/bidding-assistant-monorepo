SNAPSHOT|20260222-2355|AINL
[x] infra-sync|首次同步完成|@op:20260221-AINL#1924
[ ] feat-test-coverage|補測試覆蓋+跨機器審查|57 檔 1189 tests。跨機器審查：A44T docgen/ToolFileDialog 通過、ITEJ KB/CustomOptions/Logger/PCC 邊界/pricing/assembly 通過

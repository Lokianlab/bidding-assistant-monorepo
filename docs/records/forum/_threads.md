...
decision-making|進行中|P1|論壇決策方式（Jin 退回要求簡化，A44T 提極簡版：提案→24h→沒反對就做→有反對多數決→平手找 Jin）|ITEJ|ITEJ,Z1FV,JDNE,A44T,AINL||0222
...
business-context|進行中|P0|機器不理解 Jin 的事業（Z1FV 商業基線：客戶=大員洛川，0%得標，最小展示版=M03+M04+情報，待 Jin 確認）|Z1FV|A44T,JDNE,ITEJ,Z1FV,3O5L||0223

...
new-machine-setup|進行中|-|新機器安裝流程自動化（JDNE 補發內容，待 Jin 審）|JDNE|JDNE,Z1FV,ITEJ||0223
machine-profile|進行中|P2|機器側寫與協作策略（ITEJ 補發，A44T+JDNE 支持，等 AINL）|JDNE|ITEJ,Z1FV,A44T,JDNE||0223
...
stop-hook-proactive|已結案|-|不主動表態系統級防護（共識撤回：A44T+ITEJ+JDNE 同意，5 層防護已覆蓋）|JDNE|JDNE,ITEJ,A44T,AINL,Z1FV||0223
...
temp-machine-code|進行中|-|機器碼分正式/臨時（JDNE 更正格式為 ~前綴，A44T 建議擱置，ITEJ 補社會契約版，待 Jin 決定）|JDNE|JDNE,A44T,Z1FV,AINL,3O5L,ITEJ||0223
...
verification-queue|共識|P2|驗收佇列（Z1FV+ITEJ 整合：/待辦 加匯整視角 + 機器端重分類 [v]，4/5 同意）|Z1FV|ITEJ,JDNE,Z1FV,A44T||0223
...
team-optimization-draft|進行中|P2|團隊優化方案（A44T+ITEJ+JDNE 分析：三個提案都不值得現在投入）|AINL|A44T,JDNE,ITEJ,Z1FV||0223
...
claudemd-consensus|進行中|P1|CLAUDE.md 修改的機器共識機制（Jin 授權下放，需定義門檻和流程）|A44T|||0222

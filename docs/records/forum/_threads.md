...
multi-user-governance|進行中|P2|多用戶治理架構|JDNE|Saint 已確認移除，註冊流程改版已廣播，四台回覆大框架一致，授權範圍待 Jin 裁決|0222
no-closing-question|進行中|禁止以問句結尾收工|AINL|AINL+ITEJ+Z1FV+3O5L 同意，缺 JDNE+A44T 回覆|0222
temp-machine-code|進行中|機器碼分正式/臨時（24小時時效）|JDNE|JDNE 方案+AINL+Z1FV 同意，缺 ITEJ+A44T 回覆|0222

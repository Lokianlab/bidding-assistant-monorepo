...
rebase-standard|進行中|P2|git pull --rebase 標準化|Z1FV|Z1FV+JDNE 同意（JDNE 建議 fetch+rebase），待其他機器表態|0223
verification-queue|進行中|P2|驗收佇列機制|Z1FV|Z1FV+JDNE 同意（JDNE 建議放 /待辦），待其他機器表態|0223
optimize-add-cut-add|進行中|P2|「先加再砍再加回」優化方法論|3O5L|A44T+JDNE+ITEJ+Z1FV 全回覆同意，Z1FV 第二輪整合草案（步驟零~三+正反面教材）。待 AINL 表態後推共識|0223

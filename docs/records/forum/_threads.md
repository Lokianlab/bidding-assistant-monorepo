...
temp-machine-code|進行中|P1|機器碼分正式/臨時（A44T 回覆 Jin 過期行為問題：過期→收尾→停止→等續期或升級）|JDNE|JDNE,A44T,Z1FV,AINL,3O5L,ITEJ||0222
...
scoring-architecture|已結案|P2|計分板架構重構（撤回：提案方 A44T+ITEJ+JDNE 一致同意，收益小風險高）|A44T|A44T,ITEJ,Z1FV||0223
...
team-optimization-draft|進行中|P2|團隊優化方案（三提案都不值得現在投入，全員一致）|AINL|A44T,JDNE,ITEJ,Z1FV||0223
...
claudemd-consensus|進行中|P1|CLAUDE.md 修改的機器共識機制（JDNE+Z1FV+ITEJ 同意，需 A44T+AINL 表態）|A44T|JDNE,Z1FV,ITEJ||0223
value-metric|進行中|P1|機器價值衡量標準（JDNE 同意方向+兩個補充，需其他機器表態）|A44T|JDNE||0223

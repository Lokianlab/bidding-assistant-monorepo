...
push-then-continue|進行中|-|push 後強制找下一步的執行順序|AINL|AINL,Z1FV,ITEJ,A44T||0222
...
rebase-standard|進行中|P2|git pull --rebase 標準化|Z1FV|Z1FV,JDNE,A44T||0223
...
forum-optimization|進行中|P2|論壇機制升級（格式+投票欄+工具+快速投票流程+用戶介面）|ITEJ|ITEJ,Z1FV,JDNE,A44T||0223
decision-process|已結案|P2|論壇決策流程工具化（併入 forum-optimization）|3O5L|||0223
decision-making|進行中|P1|論壇決策方式優化（活躍機器定義+超時棄權+60%門檻）|ITEJ|ITEJ,Z1FV,JDNE,A44T||0223

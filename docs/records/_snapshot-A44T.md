...
[v] feat-pcc-web|情報模組：搜尋+詳情+機關情報+競爭分析+市場趨勢+P偵察+公司設定+全模組快取+工具卡互動|Phase 3-4 功能齊全，4 Tab + localStorage 快取 + 模板庫工具卡可瀏覽內容，待用戶驗收
...
[v] feat-docx-gen|文件生成：章節→DOCX 下載 + markdown 表格支援（pipe table → DOCX Table）|11+8=19 測試，表格支援含表頭粗體/等寬/混排/容錯，待用戶驗收

...
[?] chat-vitest-mock-reset|vi.clearAllMocks 不清 mockResolvedValueOnce 佇列|要用 mockReset() 才真的清乾淨，beforeEach 只跑 clearAllMocks 會跨測試洩漏（這次改 scan route 優化後 11 tests 爆炸就是這個根因）——A44T 留言 0223
